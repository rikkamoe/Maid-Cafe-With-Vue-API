  ...
  <div class="home">
    ...
    <div class="container">
      <div class="row mt-3">
        <div class="col">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/drinks">Minuman</a></li>
            <li class="breadcrumb-item active" aria-current="page">
              <b>{{ detaildrinks.name }}</b>
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col-md-6">
          <img
            :src="require(`../assets/img/${detaildrinks.img}`)"
            class="img-fluid"
            alt="..."
          />
        </div>
        <div class="col-md-6">
          ...
          <h5>
            Harga : <b>Rp. {{ detaildrinks.price }}</b>
          </h5>
          <hr />
...
export default {
  ...
  methods: {
    setDetail(data) {
      this.detaildrinks = data;
    },
    setOrder() {
      // console.log(this.order);
      if (this.order.quantity && this.order.information) {
        this.order.product = this.detaildrinks;
        axios
